...
namespace sp {
    ...
    void DemoScene::InitDisplayObjects() {
        auto sprite = new Sprite("resources/mtl_o_c.png", "resources/mtl_o_n.png");
        objects.push_back(sprite);
        sprite->x(100);
        sprite->y(400);
        sprite->z(0.2);

        auto sprite2 = new Sprite("resources/mtl_o_c.png", "resources/nm_cone64x64.png");
        ...
        for (float xp = 0; xp < 800; xp += 128) {
            for (float yp = 0; yp < 600; yp += 128) {
                auto bg = new Background("resources/cracked_c.png", "resources/cracked_n.png");
                bg->x(xp);
                bg->y(yp);
